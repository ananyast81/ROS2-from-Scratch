  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_key_CountUntil_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
// functions for my_robot_interfaces::action::CountUntil_SendGoal_Request already declared above

// functions for my_robot_interfaces::action::CountUntil_SendGoal_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_CountUntil_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_CountUntil_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_interfaces::action::CountUntil_SendGoal_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_key_CountUntil_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_key_CountUntil_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::action::CountUntil_SendGoal_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::action::CountUntil_SendGoal_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CountUntil_SendGoal_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_robot_interfaces::action::CountUntil_SendGoal_Event *>(
...
static size_t _CountUntil_SendGoal_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CountUntil_SendGoal_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CountUntil_SendGoal_Event__callbacks = {
  "my_robot_interfaces::action",
...
static rosidl_message_type_support_t _CountUntil_SendGoal_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CountUntil_SendGoal_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_SendGoal_Event__handle;
}
...
static const rosidl_service_type_support_t _CountUntil_SendGoal__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CountUntil_SendGoal__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<my_robot_interfaces::action::CountUntil_SendGoal_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<my_robot_interfaces::action::CountUntil_SendGoal_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<my_robot_interfaces::action::CountUntil_SendGoal_Event>(),
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_key_CountUntil_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
// functions for my_robot_interfaces::action::CountUntil_GetResult_Request already declared above

// functions for my_robot_interfaces::action::CountUntil_GetResult_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_CountUntil_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_CountUntil_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_interfaces::action::CountUntil_GetResult_Event;
    is_plain =
      (
      offsetof(DataType, response) +
      last_member_size
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_key_CountUntil_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_key_CountUntil_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::action::CountUntil_GetResult_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::action::CountUntil_GetResult_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CountUntil_GetResult_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_robot_interfaces::action::CountUntil_GetResult_Event *>(
...
static size_t _CountUntil_GetResult_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CountUntil_GetResult_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CountUntil_GetResult_Event__callbacks = {
  "my_robot_interfaces::action",
...
static rosidl_message_type_support_t _CountUntil_GetResult_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CountUntil_GetResult_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_GetResult_Event__handle;
}
...
static const rosidl_service_type_support_t _CountUntil_GetResult__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CountUntil_GetResult__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<my_robot_interfaces::action::CountUntil_GetResult_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<my_robot_interfaces::action::CountUntil_GetResult_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<my_robot_interfaces::action::CountUntil_GetResult_Event>(),
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_key_CountUntil_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
